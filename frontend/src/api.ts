...
export type PredictionView = { fixtures: PredictionFixture[]; predictionsOpen: boolean; captainedFixtureId: string | null; eligibility: { eligible: boolean; startsGameweek: number }; summary: { totalPoints: number; gameweekPoints: number; wagerPoints: number; submittedCount: number; fixtureCount: number; pointsUpdatedAt: string | null } };
