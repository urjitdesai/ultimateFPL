...
router.get("/:leagueId/wagers/:gameweek", h2hWagersController.getMyWagersForGameweek);

// Get all wagers for a specific fixture in a league
// GET /api/h2h/:leagueId/fixture/:fixtureId/wagers
router.get("/:leagueId/fixture/:fixtureId/wagers", h2hWagersController.getWagersForFixture);
...
router.post("/:leagueId/resolve/:gameweek", h2hWagersController.resolveGameweekWagers);

// Void unmatched wagers at fixture kickoff (admin/cron)
// POST /api/h2h/:leagueId/void-unmatched/:fixtureId/:gameweek
router.post("/:leagueId/void-unmatched/:fixtureId/:gameweek", h2hWagersController.voidUnmatchedWagers);
