...
export function RegisterPage() {
  ...
  return <AuthShell><div className="auth-card">
    ...
    <form onSubmit={submit} noValidate>
      ...
      <button className="primary-button" disabled={isSubmitting || googleLoading}>{isSubmitting ? <LoadingIndicator compact label="Getting started…" /> : <>Get started <ArrowRight /></>}</button>
    </form>
